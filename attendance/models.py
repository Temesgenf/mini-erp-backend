...
class AttendanceRecord(models.Model):
    ...
    employee = models.ForeignKey(
        ...
        help_text="tThe employee this attendance record belongs to."
    )
    ...
    working_hours = models.DecimalField(
        ...
        blank=True,
        editable=False,
        help_text="computed hours worked(checkout - checkin"
    ...
    location = models.CharField(
        ...
        blank=True,
        null=True,
        help_text="where the employee was working is from"
    )
